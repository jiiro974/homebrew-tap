...
#
# NOTE : le repo/releases Forgejo est privé. `brew install` (via curl) doit
# pouvoir accéder aux URLs : renseigner les identifiants dans ~/.netrc
# (machine git.tail5a7648.ts.net login jro password <TOKEN>) ou rendre les
# releases publiques.
class Pafw < Formula
  desc "CLI Palo Alto Networks (Pragma-TIC) — inventaire, PAN-OS, GlobalProtect, Panorama"
  homepage "https://git.tail5a7648.ts.net/jro/pafw"
  version "0.6.2"

  on_macos do
    if Hardware::CPU.arm?
      url "https://git.tail5a7648.ts.net/jro/pafw/releases/download/v0.6.2/pafw-darwin-arm64.tar.gz"
      sha256 "2364d82a425f59287185d3a195455580406494ed61f417459940448445eaaa6f"
    else
      url "https://git.tail5a7648.ts.net/jro/pafw/releases/download/v0.6.2/pafw-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://git.tail5a7648.ts.net/jro/pafw/releases/download/v0.6.2/pafw-linux-arm64.tar.gz"
      sha256 "644c25049439f9bb2a00453be303951a3409671647f28bcf568ff91b9e06606a"
    else
      url "https://git.tail5a7648.ts.net/jro/pafw/releases/download/v0.6.2/pafw-linux-amd64.tar.gz"
